...
public class DarkBookItem extends Item implements BookInterface{
    ...
    public void getItems(Level level, Player player, InteractionHand hand) {
        if (!level.isClientSide() && hand == InteractionHand.MAIN_HAND) {
            ...
            b.add((Items.LEATHER_BOOTS));
            b.add(Items.LEATHER_LEGGINGS);
            b.add(Items.LEATHER_CHESTPLATE);
            b.add(Items.LEATHER_HELMET);
            b.add(ItemCreator.SPEAR_DARK_QUEEN.get());
